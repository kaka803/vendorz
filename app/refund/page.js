  ...
  return (
    ...
    <div className="min-h-screen mt-17 py-10 px-5 md:px-20 font-sans">
      <div className="main-container mx-auto bg-white  rounded-xl p-8">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-6 mb-4">When We Issue Refunds</h2>
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-6 mb-4">When Refunds Are Not Provided</h2>
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-6 mb-4">Store Credits Instead of Refunds</h2>
        <p className="text-gray-700 mb-4">In certain situations, we may offer Store Credits rather than a refund:</p>
        <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-6 mb-4">Important Notice</h2>
        <p className="text-gray-700 mb-6">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-6 mb-4">Refund Process & Legal Requirements</h2>
        <p className="text-gray-700 mb-6">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-6 mb-4">Resolving Disputes</h2>
        <p className="text-gray-700 mb-6">
        ...
        <p className="text-gray-700 mb-6">Thank you for choosing <span className="font-semibold">3DVendorz</span>!</p>
